...
Welcome to `aisay` contributor's guide.
...
If you experience bugs or general issues with `aisay`, please have a look
...
You can help improve `aisay` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`aisay` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `aisay`'s files. While this mechanism can
...
```
conda create -n aisay python=3 six virtualenv pytest pytest-cov
conda activate aisay
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/aisay.git
   cd aisay
   ```
...
5. Install [pre-commit]:
   ...
   `aisay` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/aisay
[issue tracker]: https://github.com/<USERNAME>/aisay/issues
